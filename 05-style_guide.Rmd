...
```{r 05-style, echo = FALSE, out.width = '80%', fig.cap = "O.P.C. (Abstruse Goose 432)", fig.link = 'https://abstrusegoose.com/432'}

knitr::include_graphics("https://abstrusegoose.com/strips/you_down_wit_OPC-yeah_you_know_me.png")
