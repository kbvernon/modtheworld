...
df <- data.frame("Rule" = c("Make the name super descriptive.", 
                            "Avoid upper case letters.",
                            "Do not use empty spaces!",
                            "Mix dashes (-) and underscores (_) when necessary."),
                 "Good" = c("",
                            "`my_r_script.R`<br>`my_r_folder`",
                            "`my_r_script.R`<br>`my_r_folder`",
                            ""),
                 "Bad"  = c("",
                            "`My_R_Script.R`<br>`My_R_Folder`",
                            "`my r script.R`<br>`my r folder`",
                            ""))
